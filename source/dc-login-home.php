    	...
    	<div class="navbar-inner">
    		<div class="container">
    			...
    			<div class="nav-collapse collapse">
    				<ul class="nav">
    					<li class="active">
    						<a href="dc-login-home.php">Home</a>
    					</li>
    					<li>
					...
					<li>
    						<a class="pull-right" href="dc-login-home.php"><?= $fgmembersite->UserFullName(); ?></a>
    					</li>
					<li>
...
<div class="container">
    	...
    	<div class="hero-unit">
    		...
    		<hr class="">
    		<a href="dc-history.php" class="btn btn-primary btn-large">Appointment details »</a>
    	</div>
